        ...
        var t = function (t, e) {
          if (window.google) {
            ...
            if (
              ...
              var D = "" != u ? { content: u } : "";
              if ("yes" == d) var F = { url: p, scaledSize: new google.maps.Size(f, m) };
              else F = null;
              "address" == r
                ? GMaps.geocode({
                    address: c,
                ...
                : "coordinates" == r &&
                  j.addMarker({ lat: s, lng: l, title: h, infoWindow: D, icon: F });
            }
            if ("marker" == a)
            ...
            if ("panorama" == a)
              GMaps.createPanorama({ el: "#ekit-google-map-" + n, lat: N, lng: Y });
          }
        };
            ...
            function d(t, e, i, n) {
              ...
              if (l)
                for (; c--; )
                  if ((a = l[(o = e[c])]))
                    for (s = a.length; s--; )
                      a[s][0] === i && (t.removeEventListener(o, a[s][1]), a.splice(s, 1));
            }
            function p(e, i, n) {
              var o = c(i);
            ...
            function P(t) {
              if (!t.defaultPrevented && t.moveEnabled) {
                ...
                t.identifier === undefined
                  ? (u(t.target, "click", g), u(document, o.move, W, i), u(document, o.end, N, i))
      ...
      244: function (t, e, i) {
        ...
        ((r = function (t, e, i) {
                  ...
                  return (
                    ...
                    (f.show = function () {
                      ...
                      if (
                        ...
                        if ((t(this._element).trigger(s), !s.isDefaultPrevented())) {
                          ...
                          var c = function () {
                            (t(a._element).removeClass(v).addClass(g).addClass(m),
                              (a._element.style[l] = ""),
                          ...
                          if (
                            ...
                            for (var o = 0; o < this._triggerArray.length; o++) {
                              var a = this._triggerArray[o],
                                s = r.getSelectorFromElement(a);
                              null !== s &&
                                (t(s).hasClass(m) || t(a).addClass(y).attr("aria-expanded", !1));
                            }
                          this.setTransitioning(!0);
                          var l = function () {
                            (e.setTransitioning(!1),
                              t(e._element).removeClass(v).addClass(g).trigger(p));
                          };
                          ((this._element.style[n] = ""),
                    ...
                    (n._jQueryInterface = function (e) {
                      return this.each(function () {
                        ...
                        if (
                          (!r && c.toggle && /show|hide/.test(e) && (c.toggle = !1),
          ...
          "object" == s(e)
            ? r(e, i(669))
            : ((o = [e, i(669)]),
              (a = "function" == typeof (n = r) ? n.apply(e, o) : n) === undefined ||
                (t.exports = a)));
      },
      669: function (t) {
        "use strict";
                    ...
                    i.docReady(function () {
                      ...
                      c.forEach(function (t) {
                        ...
                        try {
                          ...
                          return void (
                            n && n.error("Error parsing " + r + " on " + t.className + ": " + s)
                          );
                        }
                        var l = new e(t, i);
                        u && u.data(t, o, l);
          ...
          (_ = function (t, e) {
            ...
            return (
              ...
              (i.prototype._manageStamp = function (t) {
                ...
                for (
                  var l = (this._getOption("originTop") ? n.top : n.bottom) + i.outerHeight, c = r;
                  s >= c;
                  c++
                )
              ...
              t(".elementskit-navbar-nav li a").on("click", function (e) {
                ...
                if (n && i.attr("href")) {
                  ...
                  "elementskit-submenu-indicator" !== e.target.className &&
                    ...
                    r &&
                    s &&
                    i.closest(".ekit-wid-con").find(".elementskit-menu-close").trigger("click");
                }
              }));
          });
        })(jQuery);
              ...
              var u = function (t) {
                  var e,
                    ...
                    r =
                      ...
                      (i = l.width()),
                      (a = l.height()),
                      { w: i + "px", h: a + "px", cw: e * i + "px", ch: e * a + "px" });
