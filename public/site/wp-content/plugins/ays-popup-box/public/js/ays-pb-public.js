  ...
  $(document).ready(function () {
    ...
    $(document).on("click", ".ays_pb_music_sound", function () {
      ...
      if ($this.hasClass("ays_sound_active")) {
        ...
        $this
          .find(".ays_pb_fa_volume")
          .addClass("ays_pb_fa_volume_off")
          .removeClass("ays_pb_fa_volume");
        ...
        $this
          .find(".ays_pb_fa_volume_off")
          .addClass("ays_pb_fa_volume")
          .removeClass("ays_pb_fa_volume_off");
    ...
    function setCloseButtonText(closeButtonText, closeButtonImage, id, template) {
      ...
      switch (template) {
        ...
        case "notification":
          if (closeButtonImage != "") {
            text =
              "<img class='close_btn_img' src='" + closeButtonImage + "' width='30' height='30'>";
          } else {
            if (closeButtonText === "✕") {
        ...
        case "lil":
          if (closeButtonImage != "") {
            text =
              "<img class='close_btn_img' src='" + closeButtonImage + "' width='50' height='50'>";
          } else {
            text = closeButtonText;
            if (closeButtonText != "✕") {
...
window.onload = function () {
  ...
  function updateScrollbarVisibility() {
    var popups = document.querySelectorAll(
      ".ays-pb-modal, .ays_cmd_window, .ays-pb-modal-macos, .ays_ubuntu_window, .ays_winxp_window, .ays_lil_window, .ays_image_window .ays_image_main, .ays_minimal_window .ays_minimal_main, .ays_template_window, .ays_win98_window",
    );
