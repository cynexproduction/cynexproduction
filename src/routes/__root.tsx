...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "CYNEX Production" },
      { property: "og:site_name", content: "CYNEX Production" },
      { property: "og:type", content: "website" },
      { title: "CYNEX Production — Video Production in Rajkot & Ahmedabad" },
      { property: "og:title", content: "CYNEX Production — Video Production in Rajkot & Ahmedabad" },
      { name: "twitter:title", content: "CYNEX Production — Video Production in Rajkot & Ahmedabad" },
      { name: "description", content: "Creative video production house — ad films, brand videos, corporate films, animation, music videos and documentaries in Rajkot & Ahmedabad." },
      { property: "og:description", content: "Creative video production house — ad films, brand videos, corporate films, animation, music videos and documentaries in Rajkot & Ahmedabad." },
